...
int				parse_cylinder(t_splitted *tokens,
					int line_count, t_scene *scene);
int				parse_plane(t_splitted *tokens, int line_count, t_scene *scene);
int				parse_sphere(t_splitted *tokens,
					int line_count, t_scene *scene);
int				parse_focal_light(t_splitted *tokens,
					int line_count, t_scene *scene);
int				parse_camera(t_splitted *tokens,
					int line_count, t_scene *scene);
int				parse_ambience_light(t_splitted *tokens,
					int line_count, t_scene *scene);
void			store_element(t_scene *scene,
					t_scene_element scene_element, t_element_type type);
